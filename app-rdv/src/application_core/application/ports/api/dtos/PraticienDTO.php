...
class PraticienDTO
{
    ...
    public bool $est_organisation;
    public int $specialite;

    public function __construct(string $id, string $nom, string $prenom, string $ville, string $email, string $telephone, ?string $rpps_id, string $titre, bool $accepte_nouveau_patient, bool $est_organisation, int $specialite)
    {
        $this->id = $id;
        $this->nom = $nom;
        $this->prenom = $prenom;
    ...
    public function setSpecialite(int $specialite): void
    {
        $this->specialite = $specialite;
    }
}